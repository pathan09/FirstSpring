...
<title>New/Edit Account Contact</title>
</head>
<body>
	<div align="center">
		<h1>New/Edit Account Contact</h1>
		...
		<table>
			...
			<tr>
				<td>Account Info:</td>
				<td><form:select path="accountInfoId">
					<c:forEach items="${accountInfoList}" var="accountInfo">
						<option value="${accountInfo.id}">${accountInfo.name}</option>
					</c:forEach>
				</form:select></td>
			</tr>
