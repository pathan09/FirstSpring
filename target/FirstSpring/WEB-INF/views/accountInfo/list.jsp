...
<html>
    <head>
        ...
        <title>Account Info List</title>
    </head>
    <body>
    	<div align="center">
	        <h1>Account Info List</h1>
	        <h3><a href="/accountInfo/show">New Account Info</a></h3>
	        <table border="1">
	        	<th>No</th>
	        	<th>Code</th>
	        	<th>Name</th>
	        	...
	        	<tr>
					...
					<td>
						<c:url value = "/accountInfo/getOrgType" var = "myURL">
					...
					<td>
						<c:url value = "/accountInfo/getOrgIndustry" var = "myURL">
							<c:param name = "orgIndustry" value = "${test.organizationIndustry}"/>
						</c:url>
						<c:import var = "data" url = "${myURL}"/>
						<c:out value = "${data}"/>
					</td>
